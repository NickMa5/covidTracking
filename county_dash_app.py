...
app.layout = html.Div([
    ...
    html.H1("Daily Covid Cases by State and County", style={'text_align': 'center'}),
    ...
    dcc.Graph(id='cases_chart', figure={})
])
...
@app.callback(
    [Output(component_id='output_container', component_property='children'),
     Output(component_id='cases_chart', component_property='figure')],
